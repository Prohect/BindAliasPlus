...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinBack"`. Inherited from `BuiltinAliasWithArgs`.                              |

## Methods

| Name  | Signature                    | Description                                                    |
| ----- | ---------------------------- | -------------------------------------------------------------- |
| `run` | `BackAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the backward movement key. |
