...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinRight"`. Inherited from `BuiltinAliasWithArgs`.                             |

## Methods

| Name  | Signature                     | Description                                                 |
| ----- | ----------------------------- | ----------------------------------------------------------- |
| `run` | `RightAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the right movement key. |
