...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinJump"`. Inherited from `BuiltinAliasWithArgs`.                              |

## Methods

| Name  | Signature                    | Description                                       |
| ----- | ---------------------------- | ------------------------------------------------- |
| `run` | `JumpAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the jump key. |
