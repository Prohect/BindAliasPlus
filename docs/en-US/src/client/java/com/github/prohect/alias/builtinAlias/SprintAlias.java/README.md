...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinSprint"`. Inherited from `BuiltinAliasWithArgs`.                            |

## Methods

| Name  | Signature                      | Description                                         |
| ----- | ------------------------------ | --------------------------------------------------- |
| `run` | `SprintAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the sprint key. |
