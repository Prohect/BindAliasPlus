...
| [worldName](worldName.md) | `static String worldName(Minecraft mc)` | Extracts the dimension/world name |
| [posJson](posJson.md) | `static String posJson(LocalPlayer p)` | Formats player position as JSON |
...
| [targetJson](targetJson.md) | `static String targetJson(Minecraft mc, LocalPlayer p)` | Formats the targeted entity as JSON |
| [playersJson](playersJson.md) | `static String playersJson(Minecraft mc, LocalPlayer p)` | Formats nearby players with directional info |
...
| Name | Signature | Description |
|------|-----------|-------------|
| [hotbarItems](hotbarItems.md) | `static Map<String, String> hotbarItems(LocalPlayer p)` | Maps hotbar slot→item description (1-9) |
| [hotbarEmptyRanges](hotbarEmptyRanges.md) | `static String hotbarEmptyRanges(LocalPlayer p)` | Compressed empty-slot ranges for hotbar |
...
| Name | Signature | Description |
|------|-----------|-------------|
| [containerSnapshot](containerSnapshot.md) | `static ContainerSnapshot containerSnapshot(Minecraft mc, LocalPlayer p)` | Extracts container menu state |
...
| [appendTooltipIfValuable](appendTooltipIfValuable.md) | `static void appendTooltipIfValuable(Minecraft mc, LocalPlayer p, ItemStack stack, StringBuilder sb)` | Appends tooltip details for items with valuable enchants/lore |
