...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinForward"`. Inherited from `BuiltinAliasWithArgs`.                           |

## Methods

| Name  | Signature                       | Description                                                   |
| ----- | ------------------------------- | ------------------------------------------------------------- |
| `run` | `ForwardAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the forward movement key. |
...
| [AttackAlias](../AttackAlias.java/AttackAlias.md)                                                    | Same pattern for attack            |
