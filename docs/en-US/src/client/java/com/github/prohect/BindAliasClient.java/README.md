...
| [BINDING_PLUS](BINDING_PLUS.md) | `Map<InputUtil.Key, BindAliasKeyBinding>` | All active key→alias bindings |
...
| [parseKey](parseKey.md) | `InputUtil.Key parseKey(String)` | Converts a key name string to Minecraft's `InputUtil.Key` |
