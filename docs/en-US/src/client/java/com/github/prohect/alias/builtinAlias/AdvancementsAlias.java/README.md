...
Simulates holding/releasing the advancements key (default: L) to open/close the advancements screen.
...
|------|-----------|-------------|
| [run](run.md) | `run(String)` | Presses/releases `keyAdvancements` (L) |
