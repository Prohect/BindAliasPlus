...
|------|-----------|-------------|
| [unlocked](unlocked.md) | `static List<RecipeInfo> unlocked(Minecraft mc)` | Lists all currently unlocked recipes with live craftability |
| [find](find.md) | `static RecipeInfo find(Minecraft mc, String query)` | Finds the first matching unlocked recipe by item ID or name substring |
