# cfgPath field (src/client/java/com/github/prohect/BindAliasPlusClient.java)
...
Absolute path to the mod's config file: `<minecraft_config_dir>/bind-alias-plus.cfg`.
