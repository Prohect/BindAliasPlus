...
| [click](click.md) | `click(im, menu, slot, btn, act, player)` | Perform a single container click via `ClientPlayerInteractionManager#clickSlot` |
| [swapOff](swapOff.md) | `swapOff(net, idx)` | Packet-based hotbar↔offhand swap |
