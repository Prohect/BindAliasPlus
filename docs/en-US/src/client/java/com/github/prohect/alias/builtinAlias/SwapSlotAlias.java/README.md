...
| [clickSlot](clickSlot.md) | `clickSlot(im, menu, slot, btn, act, player)` | Perform a single container click via `ClientPlayerInteractionManager#clickSlot` |
| [swapSlotOffhand](swapSlotOffhand.md) | `swapSlotOffhand(net, idx)` | Packet-based hotbar↔offhand swap |
