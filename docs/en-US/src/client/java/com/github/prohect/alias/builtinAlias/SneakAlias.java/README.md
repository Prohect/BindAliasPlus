...
| _(inherited)_ `builtinAliasName` | `String`  | The alias name `"builtinSneak"`. Inherited from `BuiltinAliasWithArgs`.                             |

## Methods

| Name  | Signature                     | Description                                        |
| ----- | ----------------------------- | -------------------------------------------------- |
| `run` | `SneakAlias run(String args)` | Presses (`"1"`) or releases (`"0"`) the sneak key. |
