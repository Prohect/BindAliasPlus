 ...
 * <p>
 * In 26.1.x: {@code Minecraft.screen} (field) and
 * {@code Minecraft.setScreen(Screen)} (method). In 26.2+: both were moved into
 * the {@code Gui} class, accessed via {@code client.gui.screen()} and
 * {@code client.gui.setScreen(Screen)}.
 * <p>
