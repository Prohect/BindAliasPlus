...
/**
 * Toggles a flag that prevents Minecraft from grabbing the mouse cursor. When
 * active, {@code MouseMixin} cancels {@code grabMouse()} at HEAD, keeping the
 * cursor free for a better dev/test experience.
 * <p>
