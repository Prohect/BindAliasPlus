...
/**
 * Builtin alias to control silent mode (suppress feedback messages) Usage:
 * builtinSilent\1 to enable, builtinSilent\0 to disable Shortcuts: +silent to
 * enable, -silent to disable
 */
