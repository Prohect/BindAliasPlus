...
/**
 * Shows/hides the debug overlay (F3) — FPS, coordinates, entity counts, etc. Uses {@code getDebugHud().toggleDebugHud()} since
 * the debug keys are intercepted at the GLFW level, not polled via KeyMapping.
 */
