...
/**
 * Simulates holding/releasing the player-list key (Tab). Shows the online-player overlay while held — useful for an agent to
 * capture via screenshot and identify who is online.
 */
