...
/**
 * Triggers a Minecraft screenshot by calling {@link Minecraft#handleGlobalKeyPress(InputConstants.Key, boolean)} with the
 * {@code keyScreenshot} keybinding — the same codepath as a native F2 keypress. Avoids depending on internal {@code Screenshot}
 * class details that may vary across branches.
 */
