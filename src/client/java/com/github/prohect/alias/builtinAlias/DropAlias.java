...
public class DropAlias extends BuiltinAliasWithBooleanArgs<DropAlias> {
     ...
     * {@link #flag} is {@code true}.  After an initial delay, drives
     * continuous dropping — {@code onMouseClick(…, THROW)} in handled
     * screens, {@code dropKey.timesPressed++} in the 3D game.
     */
    ...
    /**
     * On cursor re-lock, maintain the KeyBinding state without
     * incrementing timesPressed — otherwise an extra drop would fire.
     */
    @Override
