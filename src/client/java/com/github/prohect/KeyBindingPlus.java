 ...
 *
 * @param aliasNameOnKeyPressed  the alias to run when key is pressed
 * @param aliasNameOnKeyReleased the alias to run when key is released
 * @param fromAutoload           true if this binding was loaded from config file
 */
