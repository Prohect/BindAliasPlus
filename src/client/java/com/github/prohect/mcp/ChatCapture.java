...
public final class ChatCapture {
    ...
    // ---- Log4j appender (one-time init, captures mod log output) ----

    private static final String LOGGER_NAME = "bind-alias-plus";
    private static final Object initLock = new Object();
    private static boolean initialized;

    /** Register a Log4j appender that feeds mod log messages into {@link #onMessage(String)}. Safe to call multiple times. */
