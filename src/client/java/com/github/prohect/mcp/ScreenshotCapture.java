 ...
 * screenshot capture pipeline. Static fields live here rather than on the mixin
 * class itself (Mixin forbids non-private static members), and this class is
 * deliberately <b>outside</b> the mixin package so the Mixin framework doesn't
 * try to transform it.
 */
